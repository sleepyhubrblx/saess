...
--     "local Library = _G.SleepyLib" above this line instead. ═══
-- ══════════════════════════════════════════════════════════════════════════════
...
if not _G.SleepyMm2AntiAFK then
    _G.SleepyMm2AntiAFK = true
...
local function MakeBox(setup)
    ...
    box.highlight.Name = "SleepyMm2ESP"
...
do
    ...
    if not G.SleepySheriffHooked then
        G.SleepySheriffHooked = true
        local mod
...
ServerSub:AddSlider({
    ...
    Callback = function(v) _G.SleepyHopMax = v end,
})
ServerSub:AddButton({
    ...
    Callback = function()
        ...
        task.spawn(function()
            local ok,err=pcall(function()
                ...
                local best=nil
                local maxPlayers=_G.SleepyHopMax or 12
...
-- BOOT
-- ══════════════════════════════════════════════════════════════════════════════
Notify("MM2", "sleepy hub loaded — Coins: "..tostring(GetCoins()).." | Role: "..GetRole(), "Success", 3)
