...
local function safeCallback(fn)
    return function(...)
        ...
        if not ok then
            pcall(Notify, "sleepy hub", "Error: " .. tostring(err), "Error", 4)
        end
    end
end
...
hub.Unload = function()
    ...
    _G.sleepyStealAnEgg = nil
end

Notify("sleepy hub", "sleepy hub loaded successfully!", "Success", 3.5)
